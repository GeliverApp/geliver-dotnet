...
var tx = await client.Transactions.CreateAsync(new {
  ...
  recipientAddress = new { name = "OneStep Recipient", phone = "+905000000000", address1 = "Atatürk Mahallesi", countryCode = "TR", cityName = "Istanbul", cityCode = "34", districtName = "Esenyurt" },
